...
print("<body bgcolor='khaki'><h1>Welcome to Python.....OK...@</h1>")
...
curryear = 2024
storecode = 1
weekend = weekend_or_weekday(curryear, monthnumber, 5)
weekdayno = which_day(curryear, monthnumber, 5)
p1 = 0
p2 = 0
...
print("<h1>Predicted Value is: ", predictions)
print("</body></html?")
